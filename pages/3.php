...
<head>
  <meta charset="utf-8">
  <!-- redirect after 120 seconds--> <meta http-equiv="refresh" content="180;url=1.php" />  <title>How interesting was the idea?</title>
  <meta name="description" content="Animated lightbulbs, one dropping and one alert">
...
<body>
  <div id="lightbox"></div>
    ...
    <div id="main">
      ...
      <div id="survey">
      <img  src="../images/1-concept.gif"  alt="Animated lightbulbs, one dropping and one alert"/>
