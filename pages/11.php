...
<head>
  ...
  <meta name="description" content="An enthusiastic hand hits the high strikers leaving his friend limp and alone">
...
<body>
  <div id="lightbox"></div>
    ...
    <div id="main">
      ...
      <div id="survey">
      <img  src="../images/9-enthusiasm.gif"  alt="An enthusiastic hand hits the high strikers leaving his friend limp and alone"/>
